          ...
          <div className="container">
            <div className="citizen-intro-card">
              <div className="citizen-intro-copy">
                ...
                <p>
                  Dilux Citizen programme is built for people who want more than a transaction. It is for interns, sponsors, corpers, IT students, and associate citizens who can help buyers, sellers, and investors access verified land and property opportunities with clarity, confidence, and professionalism.
                </p>

...
import { MapPin,Mail, Phone, CalendarCheck,SendHorizontal } from "lucide-react";
      ...
      <section id="contact-form-section">
        <div className="container contact-us-form-container">
          <div>
             ...
             <p>
              Once your email is sent we will respond and get in touch with you within 24 hours
             </p>

             <p>
              <MapPin/> 1007 Adeola Odeku St, Victoria Island, Lagos
             </p>
             <p> <Phone /> +234 7046 253 045 (NGN/whats app)</p>
             <p> <Mail />Contact@diluxproperties.com</p>
          </div>
          <form>
            <div className="input-container">
              <label htmlFor="name">Name</label>
              <input type="text" required autoComplete="name" id="name" name="name" placeholder="Eg: Johon Doe" />
            </div>
            <div className="input-container">
              <label htmlFor="email">Email</label>
              <input required autoComplete="email" type="email" id="email" name="email" placeholder="Eg: johndoe@email.com" />
            </div>
            <div className="input-container">
